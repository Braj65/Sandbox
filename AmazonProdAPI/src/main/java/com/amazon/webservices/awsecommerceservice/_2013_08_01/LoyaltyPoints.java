...
/**
 *  LoyaltyPoints bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class LoyaltyPoints implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localLoyaltyPoints.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static LoyaltyPoints parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            LoyaltyPoints object = new LoyaltyPoints();
