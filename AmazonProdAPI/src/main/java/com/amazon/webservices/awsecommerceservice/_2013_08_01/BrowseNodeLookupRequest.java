...
/**
 *  BrowseNodeLookupRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class BrowseNodeLookupRequest implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * validate the array for BrowseNodeId
     */
    protected void validateBrowseNodeId(java.lang.String[] param) {
    }
     ...
     */
    public void addBrowseNodeId(java.lang.String param) {
        if (localBrowseNodeId == null) {
            localBrowseNodeId = new java.lang.String[] {  };
        }

        //update the setting tracker
        localBrowseNodeIdTracker = true;

        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localBrowseNodeId);
        list.add(param);
        this.localBrowseNodeId = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":BrowseNodeLookupRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localBrowseNodeIdTracker) {
            if (localBrowseNodeId != null) {
                ...
                for (int i = 0; i < localBrowseNodeId.length; i++) {
                    if (localBrowseNodeId[i] != null) {
                        writeStartElement(null, namespace, "BrowseNodeId",
                            xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static BrowseNodeLookupRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            BrowseNodeLookupRequest object = new BrowseNodeLookupRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"BrowseNodeLookupRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (BrowseNodeLookupRequest) com.amazon.webservices.awsecommerceservice._2013_08_01.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                    ...
                    object.setBrowseNodeId((java.lang.String[]) list1.toArray(
                ...
                if ((reader.isStartElement() &&
                    ...
                    // call the converter utility  to convert and set the array
                    object.setResponseGroup((java.lang.String[]) list2.toArray(
