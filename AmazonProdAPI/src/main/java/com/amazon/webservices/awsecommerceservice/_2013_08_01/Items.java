...
public class Items implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static Items parse(javax.xml.stream.XMLStreamReader reader)
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "Items").equals(
                                    reader.getName())) {
                            object.setItems(com.amazon.webservices.awsecommerceservice._2013_08_01.Items_type3.Factory.parse(
                                    reader));
