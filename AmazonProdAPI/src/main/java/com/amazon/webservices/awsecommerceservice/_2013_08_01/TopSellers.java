...
/**
 *  TopSellers bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TopSellers implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localTopSellers.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static TopSellers parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            TopSellers object = new TopSellers();
