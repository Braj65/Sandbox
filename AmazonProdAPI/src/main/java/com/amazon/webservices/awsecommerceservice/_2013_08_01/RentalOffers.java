...
/**
 *  RentalOffers bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RentalOffers implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localRentalOffers.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static RentalOffers parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RentalOffers object = new RentalOffers();
