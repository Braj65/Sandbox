...
/**
 *  Promotions bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Promotions implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localPromotions.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static Promotions parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Promotions object = new Promotions();
