...
/**
 *  RelatedItems bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RelatedItems implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localRelatedItems.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static RelatedItems parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RelatedItems object = new RelatedItems();
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "RelatedItems").equals(
                                    reader.getName())) {
                            object.setRelatedItems(com.amazon.webservices.awsecommerceservice._2013_08_01.RelatedItems_type0.Factory.parse(
                                    reader));
