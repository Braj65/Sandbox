...
/**
 *  TopItemSet bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TopItemSet implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localTopItemSet.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static TopItemSet parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            TopItemSet object = new TopItemSet();
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "TopItemSet").equals(
                                    reader.getName())) {
                            object.setTopItemSet(com.amazon.webservices.awsecommerceservice._2013_08_01.TopItemSet_type0.Factory.parse(
                                    reader));
