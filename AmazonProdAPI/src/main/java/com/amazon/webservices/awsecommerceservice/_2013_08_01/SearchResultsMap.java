...
/**
 *  SearchResultsMap bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SearchResultsMap implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localSearchResultsMap.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static SearchResultsMap parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SearchResultsMap object = new SearchResultsMap();
