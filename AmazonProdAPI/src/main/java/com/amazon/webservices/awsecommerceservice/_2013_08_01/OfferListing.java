...
/**
 *  OfferListing bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class OfferListing implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localOfferListing.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static OfferListing parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            OfferListing object = new OfferListing();
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "OfferListing").equals(
                                    reader.getName())) {
                            object.setOfferListing(com.amazon.webservices.awsecommerceservice._2013_08_01.OfferListing_type0.Factory.parse(
                                    reader));
