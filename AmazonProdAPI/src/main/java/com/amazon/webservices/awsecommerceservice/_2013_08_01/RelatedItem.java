...
/**
 *  RelatedItem bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RelatedItem implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localRelatedItem.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static RelatedItem parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            RelatedItem object = new RelatedItem();
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "RelatedItem").equals(
                                    reader.getName())) {
                            object.setRelatedItem(com.amazon.webservices.awsecommerceservice._2013_08_01.RelatedItem_type0.Factory.parse(
                                    reader));
