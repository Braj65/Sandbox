...
/**
 *  ItemLinks bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ItemLinks implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localItemLinks.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static ItemLinks parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            ItemLinks object = new ItemLinks();
