...
/**
 *  SimilarProducts bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SimilarProducts implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localSimilarProducts.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static SimilarProducts parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SimilarProducts object = new SimilarProducts();
