...
/**
 *  NewReleases bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class NewReleases implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localNewReleases.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static NewReleases parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            NewReleases object = new NewReleases();
