...
/**
 *  Accessories bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Accessories implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localAccessories.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static Accessories parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Accessories object = new Accessories();
