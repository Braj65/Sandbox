...
/**
 *  CustomerReviews bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CustomerReviews implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localCustomerReviews.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static CustomerReviews parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CustomerReviews object = new CustomerReviews();
