...
/**
 *  Variations bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Variations implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localVariations.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static Variations parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Variations object = new Variations();
