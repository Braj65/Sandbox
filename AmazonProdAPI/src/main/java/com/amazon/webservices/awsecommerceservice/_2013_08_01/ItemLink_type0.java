...
/**
 *  ItemLink_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ItemLink_type0 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ItemLink_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ItemLink_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ItemLink_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ItemLink_type0 object = new ItemLink_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ItemLink_type0".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ItemLink_type0) com.amazon.webservices.awsecommerceservice._2013_08_01.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
