...
/**
 *  BrowseNodes bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class BrowseNodes implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localBrowseNodes.serialize(MY_QNAME, xmlWriter);
    }
    ...
    public static class Factory {
         ...
         */
        public static BrowseNodes parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            BrowseNodes object = new BrowseNodes();
